...
<html lang="en">
<head>
  <!-- Including header meta sction here -->
  <?php
  //Header Meta Section
  include 'assets/templates/template-header-meta.php';
  ?>
  <title>Property Developer, Real Estate Builder in Bhubaneswar | Something for Everyone - Home</title>
  <body>
    <div class="animsition">
      <div class="wrapper boxed">
        ...
        <!-- Including Navigation Template Here -->
        <?php
...
<div class="content">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <h2 class="section-title section-about-title">Who is JSK INFRA?</h2>
          <p><strong>JAI SHREE KRISHNA INFRA PVT LTD</strong> was incorporated in the year 2012 by <strong>MR. BIJAY
            UPADHYAY</strong>, the first generation entrepreneur. Today, the company enjoys a strong presence in
            <strong>ODISHA</strong> and has made its position as one of the <strong>TRUSTED</strong> companies in the <strong>Real
            Estate Industry</strong>. The company is one of the fastest growing entities in the realty sector with a
            difference that offers luxury for reasonable costs, excellent customer care levels with highest
            customer satisfaction index and the highest imaginable standards for the welfare of its staff,
            society as well as for the environment.
            The Company has traversed a path of steady growth & expansion and has posted increasing
            turnover and profits year after year. The systems have been strengthened and new processes
            have been added.</p>
        ...
        <div class="client-carousel owl-carousel">
          <div class="client-carousel-item">
            ...
            <div class="client-box">
              ...
              <p class="client-description">I am thankful to <strong>JSK INFRA</strong> for their support and expertise in finding me an apartment in Bhubaneswar. For a first time buyer, they not only helped find a right property, they also assisted me with all legal and commercial concerns. </p>
            </div>
          </div>
          <div class="client-carousel-item">
            ...
            <div class="client-box">
              ...
              <p class="client-description">Buying a flat is a difficult thing in Bhubaneswar. <strong>JSK Infra</strong> made it very easy for us to select and buy a flat as per our requirements. They assisted us very well, provided several options and allowed us to choose as per our need and time. We truly appreciate their effort in helping us throughout the process. Thank you <strong>JSK Infra</strong> for the assistance you gave us in purchasing our dream home.</p>
            </div>
          </div>
          <div class="client-carousel-item">
            ...
            <div class="client-box">
              ...
              <p class="client-description">I thank <strong>JSK Infra</strong> for their prompt services towards my investment requirement and proposing numerous options. Thank you <strong>JSK Infra</strong> for this professional approach in this much needed market conditions.</p>
            </div>
          </div>
          <div class="client-carousel-item">
            <img alt="" class="client-img" src="images/clients/2-92x92.jpg">
            <div class="client-box">
              ...
              <p class="client-description"> It was a very smooth transaction, <strong>JSK Infra</strong> helped a lot in finding the right property according to my budget. Very happy with <strong>JSK Infra</strong>'s services.</p>
            </div>
          </div>
          <div class="client-carousel-item">
            <img alt="" class="client-img" src="images/clients/2-92x92.jpg">
            <div class="client-box">
              ...
              <p class="client-description">I am very much happy with the services <strong>JSK Infra</strong> is delivering to me. Everything is getting done on time and the property advisor assigned to me is really very helpful.</p>
            </div>
          </div>
          <div class="client-carousel-item">
            <img alt="" class="client-img" src="images/clients/2-92x92.jpg">
            <div class="client-box">
              ...
              <p class="client-description"><strong>JSK Infra</strong> staff delivered on their promise right from the beginning. They efficiently processed my paperwork and got me the exact location and floor of my preference.</p>
            </div>
          </div>
          <div class="client-carousel-item">
            <img alt="" class="client-img" src="images/clients/2-92x92.jpg">
            <div class="client-box">
              ...
              <p class="client-description">I had the choice of many real estate brokers, but selected <strong>JSK Infra</strong> because they were the most service oriented. Their sales staff is the most professional and best trained.</p>
            </div>
          </div>
        </div>
  ...
  <!-- Footer, Bottom Menu and Script Sction -->
  <?php
  include 'assets/templates/template-footer-script-bottom-navigation.php';
  ?>
